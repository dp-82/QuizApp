 ...
 */
class ThirdFragment(var score:Int) : Fragment(),View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        if(fragmentView!!.findViewById<RadioGroup>(R.id.radioGroupFirst).checkedRadioButtonId==R.id.rbTim){
            score++
        }
